...
```bash
wget https://github.com/thefistedpigeon/ServerDeck/releases/download/ServerDeck-v1.23.0/serverdeck-v1.23.0.py
```
## Installation
...
```bash
sudo chmod +x ./serverdeck-v1.23.0.py
```

Install the service:

```bash
sudo ./serverdeck-v1.23.0.py --install-service
```
...
```bash
sudo ./serverdeck-v1.23.0.py --install-service -port 8081
```
