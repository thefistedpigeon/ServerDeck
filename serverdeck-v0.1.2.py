...
APP_NAME = "ServerDeck"
APP_VERSION = "0.1.2"
APP_BUILD = "2026-07-29-folder-browser"
DEFAULT_PORT = 8081
MAX_BODY = 1024 * 1024
...
def browse_directory(raw_path: str) -> Dict[str, Any]:
    """Return folders visible to the account running ServerDeck."""
...
<div class="shell"><main>{body}</main><div class="footer">{APP_NAME} {APP_VERSION} · Build {APP_BUILD} · Keep this service on a trusted LAN or behind a VPN.</div></div>
    ...
    def do_GET(self) -> None:
        ...
        try:
            if path == "/":
                ...
                self.send_json(browse_directory(requested_path))
