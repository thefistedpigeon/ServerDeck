...
APP_NAME = "ServerDeck"
APP_VERSION = "0.9.0"
APP_BUILD = "2026-07-30-disks-network-pages"
DEFAULT_PORT = 8081
MAX_BODY = 1024 * 1024
...
def nav(active: str, username: str, csrf_token: str) -> str:
    items = [("overview", "/", "Overview"), ("updates", "/updates", "Updates"), ("backup", "/backup", "rSync"), ("disks", "/disks", "Disks"), ("network", "/network", "Network"), ("terminal", "/terminal", "Terminal")]
