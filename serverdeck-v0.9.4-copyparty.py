...
APP_NAME = "ServerDeck"
APP_VERSION = "0.9.4"
APP_BUILD = "2026-08-11-copyparty-page"
DEFAULT_PORT = 9090
MAX_BODY = 1024 * 1024
...
class CopyPartyManager:
    """Download the official CopyParty self-extracting Python build and optional thumbnail packages."""
    ...
    def status(cls) -> Dict[str, Any]:
        ...
        if installed:
            try:
                ...
                installed = False
        package_status = {name: cls._package_installed(name) for name in COPYPARTY_THUMBNAIL_PACKAGES}
        return {
            "installed": installed,
            "path": str(script),
    ...
    def install_thumbnail_packages(self) -> Dict[str, Any]:
        ...
        # Use the shared APT lock key so this cannot overlap with Updates-page package operations.
...
COPYPARTY_BODY = r"""
<section class="hero"><div><h1>CopyParty</h1><p>Download the official CopyParty single-file server script and install optional thumbnail dependencies.</p></div><span id="copyparty-state" class="pill">Checking…</span></section>
<div class="notice warning" style="margin-bottom:18px">The download comes directly from CopyParty's official GitHub <span class="mono">latest</span> release URL. ServerDeck installs the script at <span class="mono">/opt/copyparty/copyparty-sfx.py</span>. Downloading CopyParty does not automatically start it or create a service.</div>
...
<div class="grid">
  ...
  <article class="card span-12"><div class="section-title"><h2>Operation output</h2><span id="copyparty-task-state" class="pill">Idle</span></div><pre class="output" id="copyparty-output">No CopyParty operation has been started in this browser session.</pre></article>
</div>
"""

COPYPARTY_JS = r"""
let copypartyStatus=null;
...
class Application:
    def __init__(self, config: Config):
        ...
        self.copyparty = CopyPartyManager(self.tasks)
    ...
    def do_GET(self) -> None:
        ...
        try:
            ...
            if path == "/":
                ...
                self.send_json(self.app.copyparty.status())
